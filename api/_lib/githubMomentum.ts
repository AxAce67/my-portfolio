// Ported from the old Next.js route (src/app/api/github/momentum/route.ts,
// removed during the Vite migration). Shared by api/github/momentum.ts
// (Vercel, production) and the Vite dev-server middleware (vite.config.ts,
// local `npm run dev`).
